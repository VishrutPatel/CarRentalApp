...
class SuperAdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create super_admin" do
    assert_difference('SuperAdmin.count') do
      post super_admins_url, params: { super_admin: { Email: @super_admin.Email, Name: @super_admin.Name, Password: @super_admin.Password } }
    end
  ...
  test "should update super_admin" do
    patch super_admin_url(@super_admin), params: { super_admin: { Email: @super_admin.Email, Name: @super_admin.Name, Password: @super_admin.Password } }
